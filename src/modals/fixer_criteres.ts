...
export class CriteriaPage { // Modal pour fixer les critères de recherche
...
itemTapped(event){ // Pour lancer la recherche
...
closeModal(){ // Pour masquer la fenêtre
  this.viewCtrl.dismiss();
}

initializeItems(){ // Pour récupérer la liste des suggestions
    this.items = [
...
getItems(ev){ // Une fois l'utilisateur saisie une lettre, la liste des suggestions sera réduit
    this.initializeItems();
